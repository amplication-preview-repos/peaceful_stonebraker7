...
import { DoctorScheduleList } from "./doctorSchedule/DoctorScheduleList";
import { DoctorScheduleCreate } from "./doctorSchedule/DoctorScheduleCreate";
import { DoctorScheduleEdit } from "./doctorSchedule/DoctorScheduleEdit";
import { DoctorScheduleShow } from "./doctorSchedule/DoctorScheduleShow";
  ...
  return (
    <div className="App">
      ...
      >
        ...
        <Resource
          name="DoctorSchedule"
          list={DoctorScheduleList}
          edit={DoctorScheduleEdit}
          create={DoctorScheduleCreate}
          show={DoctorScheduleShow}
        />
        <Resource
          name="Patient"
          list={PatientList}
